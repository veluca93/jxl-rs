...
use super::{
    JxlBasicInfo, JxlCms, JxlColorProfile, JxlDecoderOptions, JxlPixelFormat,
    box_parser::BoxParser, codestream_parser::CodestreamParser,
};
...
pub struct JxlDecoderInner {
    ...
    pub(super) box_parser: BoxParser,
    pub(super) codestream_parser: CodestreamParser,
}
